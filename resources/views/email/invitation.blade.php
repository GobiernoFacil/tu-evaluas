...
<body>
    	...
    	Para ello, te pedimos que nos ayudes a responder una encuesta que te tomará alrededor de 5 minutos.-->
       Bienvenido a la plataforma Tú Evalúas mediante la cual podrás expresar tu opinión acerca de los Fondos Sectoriales del CONACYT. Para ello, te pedimos que nos ayudes a responder una encuesta que te tomará alrededor de 5 minutos. 
      </p>
        ...
        <p style="font-family: 'Open Sans Light', Helvetica, Arial, sans-serif ;color:#545454; font-size:16px; line-height:1.428; text-align:justify">
        Por favor haz caso omiso a este correo si ya respondiste esta encuesta.</p>
